...
class ReleaseNotesController: UIViewController {
    ...
    private lazy var effectView: UIVisualEffectView =
        .init(effect: UIBlurEffect(style: isDarkMode ? .dark : .extraLight))
